...
class YSPaynowShipping711 extends YSPaynowShipping {
     ...
     * @var string
     */
    protected string $id = 'ys_ec_paynow_ship_711';
     ...
     * @var string
     */
    protected string $title = 'PayNow 7-ELEVEN 超商取貨';
     ...
     * @var string
     */
    protected string $service_code = '01';
    ...
    public function get_settings_fields(): array {
        ...
        $fields['max_amount']['desc']    = '7-11 超商取貨金額上限（建議 20,000）';
